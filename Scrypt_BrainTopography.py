...
from PackageSources.Computation.Filter import signalfilter_EEG, Montage_fun
...
def main():
    #create the model
    Model = Cortex_Model_NeoNMM.Cortex(Nb_NMM=82)

    #load a file
    # SaveFile_Name = r'SaveFiles/BrainTopology/RS_sub1_simu.txt'
    # SaveFile_Name = r'SaveFiles/BrainTopology/Abs.txt'
    # SaveFile_Name = r'SaveFiles/BrainTopology/IS.txt'
    # SaveFile_Name = r'SaveFiles/BrainTopology/mAbs.txt'
    SaveFile_Name = r'SaveFiles/BrainTopology/mIS.txt'
    # SaveFile_Name = r'SaveFiles/BrainTopology/mRS.txt'
    # SaveFile_Name = r'SaveFiles/BrainTopology/RS.txt'
    ...
    indexes = list(range(82))
    indexes = indexes[14:]
    indexes.pop(67)
    indexes.pop(37)
    EEG = np.dot(LeadField, LFPs[indexes, :] )
    ...
    MontageFile_Name = r'PackageSources/Clinical-19channels_bipolar.txt'

    Montage, Montage_names, Montage_colors = Montage_fun(LFP = EEG, LFP_Names=EEG_Names,fileName=MontageFile_Name)

    # Display EEG montage
    ex5 = EEG_Viewer( )
    ex5.setWindowTitle('EEG')
    ex5.update(Montage, Montage_colors, Montage_names, tp)
    ex5.showMaximized()
